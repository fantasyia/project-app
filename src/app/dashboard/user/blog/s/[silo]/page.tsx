...
export default async function UserBlogSiloPage({ params }: { params: Promise<{ silo: string }> }) {
  const { silo } = await params;
  return <PublicSiloPage siloSlug={silo} basePath="/dashboard/user/blog" embedded />;
}
